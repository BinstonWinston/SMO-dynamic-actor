...
const char* getMaterialName(const al::LiveActor* actor, int);
int getMaterialCount(const al::LiveActor* actor);
...
bool isExistMaterialTexture(const al::LiveActor* actor, const char*, const char*);
